...
function DocumentPanel(props) {
  ...
  var _useState = (0, _react.useState)(null),
      ...
      documentViewerContainerElement = _useState2[0],
      setDocumentViewerContainerElement = _useState2[1];
  ...
  var hasValue = Boolean(props.value);
  var previewUrl = (0, _usePreviewUrl.usePreviewUrl)(props.value);
  ...
  var requiredPermission = props.value._createdAt ? 'update' : 'create';
  var permission = (0, _hooks.unstable_useCheckDocumentPermission)(props.documentId, props.documentType, requiredPermission); // Use a local portal container when split panes is supported
  ...
  var margins = screenIsNarrow ? _constants.MARGINS_NARROW_SCREEN_WITH_TABS : _constants.DEFAULT_MARGINS;
  ...
  }, activeView.type === 'form' && /*#__PURE__*/_react.default.createElement(_ui.Layer, null, /*#__PURE__*/_react.default.createElement(_permissionCheckBanner.PermissionCheckBanner, {
