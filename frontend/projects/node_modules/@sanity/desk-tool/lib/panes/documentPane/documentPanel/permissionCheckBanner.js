...
function PermissionCheckBanner(props) {
  ...
  return permission.granted ? null : /*#__PURE__*/_react.default.createElement(_ui.Card, {
    ...
    size: 1
  }, "Your role", plural && 's', ' ', join(currentUser === null || currentUser === void 0 ? void 0 : (_currentUser$roles = currentUser.roles) === null || _currentUser$roles === void 0 ? void 0 : _currentUser$roles.map(r => /*#__PURE__*/_react.default.createElement("code", {
    key: r.name
