...
var _resetIcon = _interopRequireDefault(require("part:@sanity/base/reset-icon"));
...
function DiscardChangesAction(_ref) {
  ...
  var deleteDraftPermission = (0, _hooks.unstable_useCheckDocumentPermission)(id, type, 'delete');
