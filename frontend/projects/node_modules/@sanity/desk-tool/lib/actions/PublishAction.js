...
var _publishIcon = _interopRequireDefault(require("part:@sanity/base/publish-icon"));
...
var _documentHistory = require("../panes/documentPane/documentHistory");
...
function getDisabledReason(reason, publishedAt) {
  if (reason === 'ALREADY_PUBLISHED' && publishedAt) {
    return /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, /*#__PURE__*/_react.default.createElement("span", null, "Published ", /*#__PURE__*/_react.default.createElement(_TimeAgo.default, {
      time: publishedAt
    })));
  }
...
function PublishAction(props) {
  ...
  var syncState = (0, _reactHooks.useSyncState)(id);

  var _useDocumentHistory = (0, _documentHistory.useDocumentHistory)(),
      historyOpen = _useDocumentHistory.open,
  ...
  var publishPermission = (0, _hooks.unstable_useCheckDocumentPermission)(id, type, 'publish');
  ...
  }, [isNeitherSyncingNorValidating, doPublish, hasValidationErrors, publishScheduled]); // eslint-disable-next-line no-nested-ternary
  ...
  return {
    ...
    icon: publishState === 'published' ? _checkIcon.default : _publishIcon.default,
