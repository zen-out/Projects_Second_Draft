...
var _IntentButton = require("../../transitional/IntentButton");
...
var ReferenceInput = /*#__PURE__*/(0, _react.forwardRef)(function ReferenceInput(props, forwardedRef) {
  var _preview$snapshot2, _preview$snapshot3, _preview$snapshot4;
  ...
  var isMissing = (value === null || value === void 0 ? void 0 : value._ref) && !preview.isLoading && preview.snapshot === null;
  ...
  var renderValue = (0, _react.useCallback)(autocompleteValue => {
    ...
    return preview.isLoading ? 'Loading…' : ((_preview$snapshot = preview.snapshot) === null || _preview$snapshot === void 0 ? void 0 : _preview$snapshot.title) || 'Untitled';
  }, [isMissing, preview]);
  ...
  var placeholder = preview.isLoading ? 'Loading…' : 'Type to search…';
  return /*#__PURE__*/_react.default.createElement(_components.FormField, {
    ...
    space: 3
  }, hasRef && !isMissing && weakIs !== weakShouldBe && /*#__PURE__*/_react.default.createElement(_Alert.Alert, {
    ...
    muted: true,
    size: 1
  }, type.weak ? /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, "This reference is currently marked as a ", /*#__PURE__*/_react.default.createElement("em", null, "strong reference"), ". It will not be possible to delete the \"", (_preview$snapshot2 = preview.snapshot) === null || _preview$snapshot2 === void 0 ? void 0 : _preview$snapshot2.title, "\"-document without first removing this reference.") : /*#__PURE__*/_react.default.createElement(_react.default.Fragment, null, "This reference is currently marked as a ", /*#__PURE__*/_react.default.createElement("em", null, "weak reference"), ". This makes it possible to delete the \"", (_preview$snapshot3 = preview.snapshot) === null || _preview$snapshot3 === void 0 ? void 0 : _preview$snapshot3.title, "\"-document without first deleting this reference, leaving this field referencing a nonexisting document."))))), value && isMissing && /*#__PURE__*/_react.default.createElement(_Alert.Alert, {
    ...
    prefix: /*#__PURE__*/_react.default.createElement(_ui.Box, {
      ...
      title: preview.snapshot ? "Open ".concat((_preview$snapshot4 = preview.snapshot) === null || _preview$snapshot4 === void 0 ? void 0 : _preview$snapshot4.title) : 'Loading…',
      intent: "edit",
      mode: "bleed",
      padding: 2,
