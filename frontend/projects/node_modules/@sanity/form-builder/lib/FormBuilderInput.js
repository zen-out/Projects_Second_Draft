...
class FormBuilderInput extends _react.default.Component {
  ...
  shouldComponentUpdate(nextProps) {
    var _this$props4 = this.props,
        ...
        oldProps = _objectWithoutProperties(_this$props4, ["path", "focusPath", "markers"]);

    var newPath = nextProps.path,
        newFocusPath = nextProps.focusPath,
        newMarkers = nextProps.markers,
        newProps = _objectWithoutProperties(nextProps, ["path", "focusPath", "markers"]);
...
function FormBuilderInputInner(props) {
  var childFocusPath = props.childFocusPath,
      ...
      type = props.type,
      value = props.value,
      rest = _objectWithoutProperties(props, ["childFocusPath", "compareValue", "component", "context", "focusPath", "markers", "isRoot", "level", "onBlur", "onChange", "onFocus", "path", "presence", "readOnly", "setInput", "type", "value"]);
