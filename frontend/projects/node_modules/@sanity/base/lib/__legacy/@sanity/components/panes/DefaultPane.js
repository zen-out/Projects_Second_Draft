...
var _grants = _interopRequireDefault(require("part:@sanity/base/grants"));
...
class DefaultPane extends _react.default.PureComponent {
  constructor(props) {
    ...
    _defineProperty(this, "renderIntentAction", (action, i) => {
      ...
      var _this$state = this.state,
          ...
          createPermission = _this$state.createPermission;
      return /*#__PURE__*/_react.default.createElement(_ui.Layer, {
        zOffset: 100000
      }, /*#__PURE__*/_react.default.createElement(_ui.Tooltip, {
        disabled: createPermission === null || createPermission === void 0 ? void 0 : createPermission.granted,
        ...
        portal: true
      }, /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_intent.default, {
        className: styles.actionButton,
        icon: action.icon,
        disabled: !(createPermission !== null && createPermission !== void 0 && createPermission.granted),
        intent: action.intent && action.intent.type,
        key: getActionKey(action, i),
        kind: "simple",
        padding: "small",
        params: action.intent && action.intent.params,
        title: createPermission !== null && createPermission !== void 0 && createPermission.granted && typeof action.title === 'string' ? action.title : undefined
      }))));
    });
    ...
    _defineProperty(this, "renderAction", (action, i) => {
      ...
      var _this$state2 = this.state,
          ...
          createPermission = _this$state2.createPermission;
      ...
      return /*#__PURE__*/_react.default.createElement("div", {
      ...
      }), action.action === 'toggleTemplateSelectionMenu' && /*#__PURE__*/_react.default.createElement(_ui.Layer, {
        zOffset: 100000
      }, /*#__PURE__*/_react.default.createElement(_ui.Tooltip, {
        disabled: createPermission === null || createPermission === void 0 ? void 0 : createPermission.granted,
        content: /*#__PURE__*/_react.default.createElement(_ui.Box, {
        ...
        portal: true
      }, /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement(_menuButton.MenuButton, {
  ...
  componentDidMount() {
    this.subscription = (0, _rxjs.combineLatest)(_grants.default.checkDocumentPermission('create', {
      _type: 'any',
      _id: 'any'
    }), _user.default.me).pipe((0, _operators.tap)((_ref) => {
  ...
  render() {
    var _this$props5 = this.props,
        ...
        initialValueTemplates = _this$props5.initialValueTemplates,
        ...
        onExpand = _this$props5.onExpand,
        renderActions = _this$props5.renderActions,
        renderHeaderViewMenu = _this$props5.renderHeaderViewMenu,
        ...
        restProps = _objectWithoutProperties(_this$props5, ["color", "title", "children", "hasTabs", "index", "initialValueTemplates", "isCollapsed", "isLoading", "isScrollable", "isSelected", "hasSiblings", "menuItems", "menuItemGroups", "onAction", "onCollapse", "onExpand", "renderActions", "renderHeaderViewMenu", "styles", "footer", "tabIdPrefix", "viewId"]);
    ...
    return /*#__PURE__*/_react.default.createElement(_components.LegacyLayerProvider, {
      zOffset: "pane"
    }, /*#__PURE__*/_react.default.createElement("div", _extends({}, restProps, {
      ...
      "data-test": "components-default-pane-header"
      ...
      className: styles.main
    }, mainChildren), footer && /*#__PURE__*/_react.default.createElement(_ui.Layer, {
