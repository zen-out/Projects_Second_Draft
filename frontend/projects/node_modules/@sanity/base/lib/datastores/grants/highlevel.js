...
function canCreateType(typeName) {
...
function canCreateAnyOf(types) {
  return (0, _rxjs.combineLatest)(types.map(typeName => canCreateType(typeName))).pipe((0, _operators.map)(results => {
...
function canUpdate(id, typeName) {
  ...
  return (0, _snapshotPair.snapshotPair)(idPair).pipe((0, _operators.mergeMap)(pair => (0, _rxjs.combineLatest)([pair.draft.snapshots$, pair.published.snapshots$])), (0, _operators.map)((_ref) => {
    ...
    return type.liveEdit ? _.default.checkDocumentPermission('update', published) : _.default.checkDocumentPermission('update', draft);
  }));
}
...
function canDelete(id, typeName) {
  var type = getSchemaType(typeName);
  var idPair = getIdPairFromPublished(id);
  return (0, _snapshotPair.snapshotPair)(idPair).pipe((0, _operators.mergeMap)(pair => (0, _rxjs.combineLatest)([pair.draft.snapshots$, pair.published.snapshots$])), (0, _operators.map)((_ref5) => {
    var _ref6 = _slicedToArray(_ref5, 2),
        draft = _ref6[0],
        published = _ref6[1];

    return [draft || stub(idPair.draftId, typeName), published || stub(idPair.publishedId, typeName)];
  }), (0, _operators.switchMap)((_ref7) => {
...
function canPublish(id, typeName) {
  var idPair = getIdPairFromPublished(id);
  return (0, _snapshotPair.snapshotPair)(idPair).pipe((0, _operators.mergeMap)(pair => (0, _rxjs.combineLatest)([pair.draft.snapshots$, pair.published.snapshots$])), (0, _operators.map)((_ref9) => {
    var _ref10 = _slicedToArray(_ref9, 2),
        draft = _ref10[0],
        published = _ref10[1];

    return [draft || stub(idPair.draftId, typeName), published || stub(idPair.publishedId, typeName)];
  }), (0, _operators.switchMap)((_ref11) => {
...
function canUnpublish(id, typeName) {
  var idPair = getIdPairFromPublished(id);
  return (0, _snapshotPair.snapshotPair)(idPair).pipe((0, _operators.mergeMap)(pair => (0, _rxjs.combineLatest)([pair.draft.snapshots$, pair.published.snapshots$])), (0, _operators.map)((_ref13) => {
    var _ref14 = _slicedToArray(_ref13, 2),
        draft = _ref14[0],
        published = _ref14[1];

    return [draft || stub(idPair.draftId, typeName), published || stub(idPair.publishedId, typeName)];
  }), (0, _operators.switchMap)((_ref15) => {
